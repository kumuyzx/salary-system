...
CREATE TABLE employee (
  ...
  password VARCHAR(100) NOT NULL DEFAULT 'Salary@2026',
  department_id INT,
...
INSERT INTO employee (id, name, sex, phone, email, grade, hiredate, power, password, department_id) VALUES
  ('1001', '陈一鸣', '男', '13810001001', 'yiming.chen@acme-corp.cn', 'P5', '2022-03-14', '1', 'Salary@2026', 1),
  ('1002', '周嘉宁', '女', '13810001002', 'jianing.zhou@acme-corp.cn', 'P6', '2021-08-02', '1', 'Salary@2026', 4),
  ('2001', '林若溪', '女', '13810002001', 'ruoxi.lin@acme-corp.cn', 'M1', '2020-11-16', '2', 'Salary@2026', 2),
  ('3001', '沈浩然', '男', '13810003001', 'haoran.shen@acme-corp.cn', 'M1', '2019-06-24', '3', 'Salary@2026', 3);
